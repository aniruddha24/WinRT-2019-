...
BOOL WINAPI DllMain(HINSTANCE hdll, DWORD dwReason, LPVOID Reserved)
{
	...
	case DLL_PROCESS_ATTACH:
		MessageBox(NULL, TEXT("DLL_PROCESSS_ATTACH_INNER"), TEXT("Message"), MB_OK);
		break;
	case DLL_PROCESS_DETACH:
		MessageBox(NULL, TEXT("DLL_PROCESS_ATTACH_INNER"), TEXT("Message"), MB_OK);
		break;
	}
	return(TRUE);
}
...
{
	MessageBox(NULL, TEXT("CoClass_QueryInterface_NoAggregation_Inner"), TEXT("COOL"), MB_OK);
...
{
	MessageBox(NULL, TEXT("CoClass_MultiplicationOfTwoIntegers_Inner"), TEXT("COOL"), MB_OK);
...
{
	MessageBox(NULL, TEXT("CoClass_DivisionOfTwoIntegers_Inner"), TEXT("COOL"), MB_OK);
	*pDivision = num1 / num2;
	return(S_OK);
}
...
{
	MessageBox(NULL, TEXT("ClassFactory_QueryINterface_Inner"), TEXT("Cool"), MB_OK);
	if (riid == IID_IUnknown)
...
{
	MessageBox(NULL, TEXT("ClassFactory_CreateInstance_Inner"), TEXT("Cool"), MB_OK);
...
{
	MessageBox(NULL, TEXT("DllGetClassObject_Inner"), TEXT("COOL"), MB_OK);
