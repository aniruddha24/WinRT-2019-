...
BOOL WINAPI DllMain(HINSTANCE hDll, DWORD dwReason, LPVOID Reserved)
{
	...
	case DLL_PROCESS_DETACH:
		MessageBox(NULL, TEXT("DLL_PROCESS_DETACH"), TEXT("Message"), MB_OK);
	}
	return(TRUE);
}
...
{
	MessageBox(NULL, TEXT("CoClass_QueryInterface_Inner"), TEXT("Message"), MB_OK);
...
{
	MessageBox(NULL, TEXT("MultiplicationOfTwoIntegers_Inner"), TEXT("Messasge"), MB_OK);
...
{
	MessageBox(NULL, TEXT("DivisionOfTwoIntergers_Inner"), TEXT("Message"), MB_OK);
	*pDivision = num1 / num2;
	return(S_OK);
}
...
{
	MessageBox(NULL, TEXT("CLassFactory_QueryInterface_Inner"), TEXT("Message"), MB_OK);
...
{
	MessageBox(NULL, TEXT("ClassFactory_CreateInstance_Inner"), TEXT("Message"), MB_OK);
...
{
	MessageBox(NULL, TEXT("DllGetClassObject_Inner"), TEXT("Message"), MB_OK);
...
{
	MessageBox(NULL, TEXT("DllCanUnloadNow_Inner"), TEXT("Message"), MB_OK);
